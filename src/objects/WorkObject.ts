...
export enum State {
    LIVE, PRODUCTION, DEVELOPMENT, INACTIVE, PLANNED
}
...
const workObjects: WorkObject[] = [
    {
        ...
        description: "I have developed Halkan.se, a platform for booking risk education " +
            ...
            "risk education.",
        imgSrc: "https://firebasestorage.googleapis.com/v0/b/portfolio-13bbf.appspot.com/o/HalkanSVG.svg?alt=media&token=4c055e3e-b3cb-47b7-a954-1876e52c127a",
    ...
    },
    {
        ...
        description: "Loyalties is a mobile application that allows users to collect loyalty points from " +
    ...
    },
    {
        ...
        skills: ["wIX", "VELO"],
        description: "During a summer project, I collaborated with Tillsammans i Engagemang (TIE), " +
        ...
        imgSrc: "https://firebasestorage.googleapis.com/v0/b/portfolio-13bbf.appspot.com/o/TIE.svg?alt=media&token=d826d740-66ad-4ffc-b282-cc82f020dafa",
    }
]
